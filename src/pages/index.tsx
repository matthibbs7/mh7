...
export default function Home() {
  return (
    <>
      ...
      <Flex justifyContent="center" backgroundImage="linear-gradient(#000 0.5px, transparent 0.5px, transparent calc(100% - 0.5px), #000 calc(100% - 0.5px)), linear-gradient(90deg, #000 0.5px, transparent 0.5px, transparent calc(100% - 0.5px), #000 calc(100% - 0.5px))" backgroundSize="0.623076923076925% 0.233333333333334%;">
        <Flex mb={10} mt={[2,5,5,5]} px={[3, 4, 6, 8]} py={[2,2,4,4]}bg="#181818" width=
        {["94%","90%"]} maxWidth="906px" borderRadius="6px" border="1px solid #212121" flexDirection="column">
          <Flex align="center">
            ...
            <Text color="bisque" style={{fontFamily: 'Gloock'}} fontSize="24.5pt" fontWeight={700}>Matthew Hibbs</Text>
