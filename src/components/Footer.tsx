  ...
  export default function Footer() {
    return (
      <Box
        ...
        <Container as={Stack} maxW={'680px'} py={10} mt={'-60px'}>
          <SimpleGrid
            ...
            <Stack spacing={3}>
              ...
              <Stack direction={'row'} spacing={6}>
                <Button height='36px' fontSize='15px' color='#2f2f2f' bgColor='rgb(33, 33, 33, 0.07)' borderRadius='8px'>Email Me</Button>
            ...
            <Stack fontSize='15px' align={'flex-start'}>
              <ListHeader><Text fontSize='15px'>Media</Text></ListHeader>
              <Link  color='#999' href={'#'} flexDirection='row' display='flex' alignItems='center'><FaLinkedin  style={{verticalAlign: 'center'}} /><Text>&nbsp;LinkedIn</Text></Link>
              <Link  color='#999' href={'#'} flexDirection='row' display='flex' alignItems='center'><FaGithubSquare  style={{verticalAlign: 'center'}} /><Text>&nbsp;GitHub</Text></Link>
              <Link  color='#999' href={'#'} flexDirection='row' display='flex' alignItems='center'><FaDev  style={{verticalAlign: 'center'}} /><Text>&nbsp;Devpost</Text></Link>

            </Stack>
            <Stack fontSize='15px' align={'flex-start'}>
              <ListHeader><Text fontSize='15px'>Projects</Text></ListHeader>
              <Link href={'#'} color='#999'>Sherlock</Link>
              <Link color='#999' href={'#'}>Sabu.ai</Link>
              <Link color='#999' href={'#'}>Haikai</Link>
              
            </Stack>
            <Stack fontSize='15px' color='#999' align={'flex-start'}>
            <ListHeader><Text fontSize='15px'>&nbsp;</Text></ListHeader>
              <Link href={'#'} color='#999'>Educatus</Link>
              <Link color='#999' href={'#'}>Rollsolid</Link>
              <Link color='#999' href={'#'}>SBD</Link>
              
            </Stack>
            <Stack fontSize='15px' align={'flex-start'}>
            <ListHeader><Text fontSize='15px'>Other</Text></ListHeader>
              <Link href={'#'} color='#999'>Manuscripts</Link>
              <Link color='#999' href={'#'}>Awards</Link>
              <Link color='#999' href={'#'}>Misc</Link>
